...
public sealed class RequestCustomObjectivesCommand : IConsoleCommand
{
    ...
    public string Description => "Sends the custom objectives player list to the requesting admin.";
    ...
    public void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        _entityManager.System<CustomObjectivesAdminSystem>().SendCustomObjectivesList(player);
    }
}
